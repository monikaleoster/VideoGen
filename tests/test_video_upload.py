...
from videogen.pipeline.video_upload import VideoUploadInput, run_video_upload, state
...
async def test_step_blocks_until_approved() -> None:
    task = asyncio.create_task(run_video_upload(VideoUploadInput(video_path="/tmp/final.mp4")))
